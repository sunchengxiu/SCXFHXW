...
- (void)viewDidLoad
{
    ...
    [regBtn setTitle:NSLocalizedString(@"获取短信验证码", nil) forState:UIControlStateNormal];
    ...
    [btn setTitle:NSLocalizedString(@"获取语音验证码", nil) forState:UIControlStateNormal];
    ...
    [friendsBtn setTitle:NSLocalizedString(@"获取通讯录好友", nil) forState:UIControlStateNormal];
    ...
    [infoBtn setTitle:NSLocalizedString(@"提交用户信息", nil) forState:UIControlStateNormal];
